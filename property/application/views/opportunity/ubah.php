      <section id="main-content">
		...
		Anda login sebagai : <?php echo $this->session->nm_projek; ?> </h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                <input class="form-control" name="id_projek" type="hidden" value="<?= $acc->id_projek?>" required>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" required="required" placeholder=" " value="<?= $acc->id_projek?> id="alamat" name='alamat' placeholder='alamat'>
              </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label" for="tgl_listing"> Tanggal Listing:</label>
                <div class="col-sm-10">
                <input type="date" class="form-control" required="required" placeholder=" " value="<?= $acc->id_projek?> id="tgl_listing" name='tgl_listing' placeholder='tgl_listing'>
              </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label" for="deskripsi"> deskripsi:</label>
                <div class="col-sm-10">
                <input type="text" class="form-control" required="required" placeholder=" " id="deskripsi" value="<?= $acc->id_projek?> name='deskripsi' placeholder='deskripsi'>
              </div>
              </div>
