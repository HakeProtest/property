	...
	<div class="col-md-4">
		<div class="panel panel-default">
		  <div class="panel-heading">Pilih Periode Tanggal dan sales</div>
		  <div class="panel-body">
		     <form class="form-horizontal style-form"  action="<?= base_url();?>c_order/hasillaporan" method="post">
	...
	<div id="printableArea">
              ...
              <div class="col-lg-12">
                      <div class="content-panel">
                        ...
                        <div>
                      <h3 align="center">Laporan Order Tanggal <?=tgl_indo($t1);?> sampai <?=tgl_indo($t2);?><br>
                      	<?php
                      	if($s1!=''){
                      		$nama = $this->db->query("select nm_account from account where id_account='$s1'")->row()->nm_account;
							?>
							Nama Sales : <?=$nama;?>
							<?php
						}else
