    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">PT TAKSI BANDUNG</a>
            </div>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <br>
                <br>
         <a href="<?= base_url();?>login" class="btn btn-primary btn-xl page-scroll">Login</a> <!--a href="<?= base_url();?>login3" class="btn btn-primary btn-xl page-scroll">Login Supir</a-->
            </div>
        </div>
    </header>
    <!-- jQuery -->
