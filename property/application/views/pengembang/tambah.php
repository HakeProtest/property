            ...
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"> Tambah Data Pengembang</h4>
                      <form class="form-horizontal style-form" action="<?= base_url();?>c_pengembang/simpan_input" method="post">
                          <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label" for="nm_pengembang"> ID Pengembang:</label>
                <div class="col-sm-10">
                <input type="text" class="form-control" required="required" placeholder=" " id="id_pengembang" name='id_pengembang' placeholder='id_pengembang'>
              </div>
              </div>
                         <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label" for="nm_pengembang"> Nama Pengembang:</label>
                <div class="col-sm-10">
                <input type="text" class="form-control" required="required" placeholder=" " id="nm_pengembang" name='nm_pengembang' placeholder='nm_pengembang'>
              </div>
              </div>
              <div class="form-group">
