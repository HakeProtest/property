            ...
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"> Tambah Data Kategori</h4>
                      <form class="form-horizontal style-form" action="<?= base_url();?>c_kategori/simpan_input" method="post">
                         
                          <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label" for="nm_kategori"> Nama Kategori:</label>
                <div class="col-sm-10">
                <input type="text" class="form-control" required="required" placeholder=" " id="nm_kategori" name='nm_kategori' placeholder='nm_kategori'>
              </div>
              </div>
